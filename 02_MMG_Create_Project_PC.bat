...
Set projpath="\\post-storage-edit\post_edit_%produnit%\02_SciTechNow_Projects\"STN_Full Shows"
...
md "%projpath%\%projid%\Bumpers"
md "%projpath%\%projid%\TechEval"
md "%projpath%\%projid%\ElementsforAspera"
